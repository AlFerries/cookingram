...
// TODO: redirect if user authorized

export default function LoginPage() {
  return (
    <form className='mx-auto py-30 flex flex-col gap-8 max-w-120 px-8'>
      <label className='flex md:items-center flex-col md:flex-row justify-between gap-4' htmlFor="email">Email:
        <input className='w-full border border-stone-300 p-2 rounded-xl' id="email" name="email" type="email" required />
      </label>
      <label className='flex md:items-center flex-col md:flex-row justify-between gap-4' htmlFor="password">Password:
